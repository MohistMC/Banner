        ...
        return this.fetchLatestVersion(cacheDir, version, executor)
                .thenCompose(build -> {
                    ...
                    if (Files.exists(this.path)) {
                        BannerMCStart.LOGGER.info(I18n.as("stackdeobf.download.already"), this.name, build);
                        return CompletableFuture.completedFuture(null);
                    }

                    URI uri = this.artifactInfo.buildUri(build, "jar");
                    BannerMCStart.LOGGER.info(I18n.as("stackdeobf.downloading"), this.name, build);
            ...
            if (Files.exists(versionCachePath)) {
                try {
                    ...
                    if (timeDiff <= maxTimeDiff) {
                        ...
                        BannerMCStart.LOGGER.info(I18n.as("stackdeobf.getbuild"),
                        ...
                        BannerMCStart.LOGGER.info(I18n.as("stackdeobf.refreshing"),
            ...
            return HttpUtil.getAsync(metaUri, executor).thenApply(resp -> {
                try (InputStream input = new ByteArrayInputStream(resp)) {
                    ...
                    for (int i = versions.getLength() - 1; i >= 0; i--) {
                        ...
                        BannerMCStart.LOGGER.info(I18n.as("stackdeobf.cached.lastest"), this.name, version);
