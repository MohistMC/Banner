...
public class Library implements Comparable<Library> {
     ...
     */
    public Library(@NonNls String groupId, @NonNls String artifactId, @NonNls String version, LibraryManager.HashAlgorithm checksumType, @NonNls String checksumValue) {
