...
public class PluginManagers {
    ...
    public static boolean loadPluginCommand(CommandSender sender, String label, String[] split) {
        if (split.length < 2) {
            Object[] f = {label};
            sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.load", f));
            return true;
        }
        ...
        if (!toLoad.exists()) {
            ...
            if (!toLoad.exists()) {
                sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.nofile",  objects));
                return true;
            } else {
        ...
        if (desc == null) {
            sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.noyml",  objects));
            return true;
        }
        ...
        for (Plugin p : plugins) {
            if (desc.getName().equals(p.getName())) {
                sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.alreadyloaded", new Object[] {desc.getName()}));
                return true;
            }
        }
        ...
        if (p != null) {
            ...
            sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.loaded", new Object[] {p.getDescription().getName(), p.getDescription().getVersion()}));
        } else {
            sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.notload", objects));
        }
    ...
    public static boolean unloadPluginCommand(CommandSender sender, String label, String[] split) {
        if (split.length < 2) {
            sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.unload", label));
            return true;
        }
        ...
        if (p == null) {
            sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.noplugin", objects));
        } else {
            if (!Control.unloadPlugin(p)) {
                sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.unloaderror", p.getDescription().getName(), p.getDescription().getVersion()));
            }
            if (Control.unloadPlugin(p)) {
                sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.unloaded", p.getDescription().getName(), p.getDescription().getVersion()));
            } else {
                sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.notunload", objects));
            }
        }
    ...
    public static boolean reloadPluginCommand(CommandSender sender, String label, String[] split) {
        ...
        if (split.length < 2) {
            sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.reload", new Object[] {label}));
            return true;
        }
        ...
        if (p == null) {
            ...
            if (file == null) {
                sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.nojar", new Object[] {p.getName()}));
                return true;
            }
            ...
            if (!Control.unloadPlugin(p)) {
                sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.reloaderror", objects));
            } else if ((loaded = (JavaPlugin) Control.loadPlugin(name)) == null) {
                sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.nojar", objects));
            }

            Bukkit.getPluginManager().enablePlugin(loaded);
            sender.sendMessage(BannerMCStart.I18N.as("pluginscommand.reloaded", new Object[] {split[1], loaded.getDescription().getVersion()}));
        }
        return true;
    }
}
