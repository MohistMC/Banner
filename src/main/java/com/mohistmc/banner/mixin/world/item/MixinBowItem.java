            ...
            if (!itemStack.isEmpty() || bl) {
                ...
                if (!((double)f < 0.1)) {
                    ...
                    if (!level.isClientSide) {
                        ...
                        // CraftBukkit start
                        org.bukkit.event.entity.EntityShootBowEvent event = CraftEventFactory.callEntityShootBowEvent(player, itemStack, stack, abstractArrow, player.getUsedItemHand(), f, !bl);
