...
/**
 * Code from @<code>https://github.com/ArclightPowered/api/blob/master/src/main/java/io/izzel/arclight/api/Unsafe.java</code>
...
public class Unsafe {
    ...
    // Banner TODO - update it to higher JDK
    /*
