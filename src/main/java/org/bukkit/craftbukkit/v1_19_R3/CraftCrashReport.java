...
public class CraftCrashReport implements Supplier<String> {
    ...
    public String get() {
        ...
        try {
            value.append("\n   Running: ").append(Bukkit.getName()).append(" version ").append(Bukkit.getVersion()).append(" (Implementing API version ").append(Bukkit.getBukkitVersion()).append(") ").append(String.valueOf(ServerUtils.getServer().usesAuthentication()));
            value.append("\n   Plugins: {");
            ...
            value.append("\n   Reload Count: ").append(String.valueOf(ServerUtils.getServer().bridge$server().reloadCount));
            value.append("\n   Threads: {");
